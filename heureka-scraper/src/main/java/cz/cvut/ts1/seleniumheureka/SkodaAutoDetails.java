...
public class SkodaAutoDetails extends Page {
    ...
    @FindBy(how = How.XPATH, using = "//button[text()='Zobrazit další parametry']")
    private WebElement seeMoreSpecs;

    @FindBy(how = How.XPATH, using = "//*[@id=\"__next\"]/main/div[2]/div[1]/div/div[12]/aside/div/button")
    ...
    public CarAdvisorySearch advisoryCarSearch() {
        ...
        jsClick(review);
        jsClick(advisory);
        return new CarAdvisorySearch(driver);
    }
}
